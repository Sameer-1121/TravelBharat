...
const AboutHero = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(https://images.unsplash.com/photo-1599661046827-dacff0c0f09a?w=1600&q=80)`,
      }}
    >
      {/* Gradient Overlay */}
      ...
      <div className="relative z-10 w-full flex items-center justify-between px-5 md:px-10 py-5 text-white">
        ...
        <div className="hidden lg:flex gap-10 font-semibold">
          ...
          <span className="text-orange-400 border-b-2 border-orange-400 pb-1 cursor-pointer">About Us</span>
      ...
      <div className="relative z-10 flex items-center h-[60vh] px-5 md:px-10 lg:px-16">
        <div className="text-white max-w-2xl">
          ...
          <p className="text-sm md:text-lg text-gray-300 leading-7 md:leading-8 max-w-lg">
            India's most comprehensive digital tourism encyclopedia — helping travelers, students, and researchers discover the beauty of Incredible India.
          </p>
        </div>
      </div>
    </div>
